    ...
    menus: {
        ...
        'remove': {
            ...
            items: [
                ...
                { name: 'Remove First Characters Of Each Line', url: '/remove/first-characters' },
                { name: 'Remove Html Comments', url: '/remove/html-comments' },
                { name: 'Remove Html Tags', url: '/remove/html-tags' },
                { name: 'Remove Last Characters Of Each Line', url: '/remove/last-characters' },
                { name: 'Remove Line Breaks', url: '/remove/line-breaks' },
                { name: 'Remove Lines Containing A Certain Word', url: '/remove/lines-with-word' },
                { name: 'Remove Numbers', url: '/remove/numbers' },
                { name: 'Remove Numbers From Text', url: '/remove/numbers-from-text' },
                { name: 'Remove Quotes From Text', url: '/remove/quotes' },
                { name: 'Remove Single Quotes From Text', url: '/remove/single-quotes' },
                { name: 'Remove Spaces', url: '/remove/spaces' },
                { name: 'Remove Special Characters', url: '/remove/special-characters' },
                { name: 'Remove Tabs From Text', url: '/remove/tabs' },
                { name: 'Remove Text Between', url: '/remove/text-between' },
                { name: 'Remove Vowels From Text', url: '/remove/vowels' },
                { name: 'Removing Leading And Trailing Spaces', url: '/remove/trim-spaces' }
            ]
        },
        'replace': {
            title: 'Replace',
